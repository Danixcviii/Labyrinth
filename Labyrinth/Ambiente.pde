class Ambiente{
  ...
  public void crearPoblacion(final PVector spawn,final float pM,final float pR,final int lifeTime,final int nI){
   p=new Poblacion(spawn,pM,pR,lifeTime,nI);
  };
  
  public void addMuro(final PVector A,final PVector B){
   muros.add(new Muro(A,B));
  };
  
  public void crearObjetivo(final PVector objetivo){
